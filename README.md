...
Проект является значительной переработкой оригинальной математической библиотеки X-Ray Engine с целью модернизации, повышения удобства работы, а также оптимизации.
