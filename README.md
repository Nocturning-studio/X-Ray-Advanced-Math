...
Проект является значительной переработкой оригинальной математической библиотеки X-Ray Engine с целью ее модернизации, повышения удобства работы с ней, а также оптимизации.
